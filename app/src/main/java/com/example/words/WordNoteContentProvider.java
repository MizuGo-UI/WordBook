...
public class WordNoteContentProvider extends ContentProvider {
    ...
    //包路径authority
    public static final String AUTHORITY = "com.example.words.provider";
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)){
            case DICT_NUM:
                return "vnd.android.cursor.dir/vnd.com.example.words.provider.dict";
        }
        return null;
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatcher.match(uri)){
            case DICT_NUM:
                long newBookId=db.insert("words",null,values);
                uriReturn=Uri.parse("content://"+AUTHORITY+"/words/"+newBookId);
                break;
        }
        return uriReturn;
    }
